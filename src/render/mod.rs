...
use wgpu::{
    Adapter, Color, Device, DeviceDescriptor, Instance, InstanceDescriptor, LoadOp, Operations,
    PowerPreference, Queue, RenderPassColorAttachment, RenderPassDescriptor, RequestAdapterOptions,
    StoreOp, Surface, SurfaceConfiguration, SurfaceTargetUnsafe,
...
impl Renderer {
    pub fn new(window: Window) -> Self {
        ...
        // window has the same lifetime as surface
        let surface = unsafe {
            instance
